...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    if terminal == True:
        q_func[current_state_1, current_state_2, action_index,
               object_index] *=(1-ALPHA) # TODO Your update here
        q_func[current_state_1, current_state_2, action_index,
...
def run_episode(for_training):
    ...
    current_room_desc_index = np.where(dict_room_desc==current_room_desc)
    current_quest_desc_index = np.where(dict_quest_desc==current_quest_desc)
    ...
    while not terminal:
        ...
        next_room_desc_index = np.where(dict_room_desc==next_room_desc)
        next_quest_desc_index = np.where(dict_quest_desc==next_quest_desc)
        if for_training:
            # update Q-function.
            # TODO Your code here
            tabular_q_learning(q_func, current_room_desc_index, current_quest_desc_index, action_index, object_index, reward, next_room_desc_index, next_quest_desc_index, terminal)
            pass
        ...
        # TODO Your code here
        t+=1
        current_room_desc_index = next_room_desc_index
        current_quest_desc_index = next_quest_desc_index
